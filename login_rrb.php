...
function firstfocus()
{
var uid = document.theForm.app.focus();
return true;
}
function validateform(theForm)
{ 
if(document.getElementById("app").value.length < 10 || document.getElementById("app").value.search("[^0-9]")>-1)
                   {                                  
...
$app=$_POST['app'];//storing username input box value in a variable $Username  $_POST['UserName'] 
$bdd=$_POST['bdd'];//$fname=$_POST['fname'];//storing $_POST['Password']  textbox in  $Password
$bmm=$_POST['bmm'];//$mname=$_POST['mname'];
$byy=$_POST['byy'];


$result=mysql_query("select * from new where regno='$app' and bdd='$bdd' and bmm='$bmm' and byy='$byy'")or die (mysql_error());//query sang database 
...
$row=mysql_fetch_array($result);//ma return row sa database
		...
		$regnoErr = "Invalid Registration No and Date of Birth";
		//echo "Invalid Registration No and Date of Birth";
		}
}
?>
...
<meta http-equiv="refresh" content="0;URL=javaError.htm" />

<h2><center><br /><br /><br /><br /><br /> Please Enable JavaScript In your Browser <br /><br /><br /><br /><br /></center></h2></noscript>

<center><h2>Login Page </h2></center>
<div align="center">
<form method="post" name="theForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" onsubmit="javascript: return validateform(theForm);">  
  <table width="431"  border="1" cellpadding="5" cellspacing="5">
    <tr>
      <td>Registration No. </td>
      <td><input name="app" type="text" id="app"  size="35" maxlength="10" required/></td>
    </tr>
    <tr>
      <td>Date of Birth </td>
  ...
  <span class="notice"><?php echo $regnoErr;?></span><br />
